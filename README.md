...
* [Erlang](https://www.erlang.org/) &sol; [Elixir](https://elixir-lang.org/): These two round out my future language learning plans. They're seeing a lot of use in blockchain, and are famous for use in telecom should I ever go that route.