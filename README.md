...
* JavaScript
    ...
    * [Mythic for Foundry](https://github.com/AugmenTab/mythic) is an implementation of a fan-made tabletop roleplaying game for [Foundry Virtual Tabletop](https://foundryvtt.com/). This system uses [Handlebars](https://handlebarsjs.com/) for HTML templating, [Less](https://lesscss.org/), and JavaScript, alongside the [Foundry API](https://foundryvtt.com/api/). In the future, I want to attempt moving some of the loose modules and included compendium macros to [PureScript](https://www.purescript.org/) or [TypeScript](https://www.typescriptlang.org/).
* Python
